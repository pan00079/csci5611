...
PImage sprite; // Sprite image

float speed = 100;

void update(float dt){
  Vec2 mousePos = new Vec2(mouseX, mouseY);
  dir = mousePos.minus(pos); //Should be vector pointing from pos to MousePos
  angle = atan2(mousePos.y-height/2, mousePos.x-width/2); // source: https://processing.org/reference/atan2_.html
